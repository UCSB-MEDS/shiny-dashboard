...
residency <- enrolled |> 
  select(c(admission_year, program, citizenship_country, residency_country, california_resident, visa)) |> 
  ...
  mutate(demographic = case_when(
    ...
    california_resident == TRUE & visa %in% c(NA, 
                                              ...
                                              "Permanent Resident",
                                              "None: DACA Recipient",
                                              "Undocumented Status") ~ "California Resident",
    
    # non-CA resident ----
    california_resident == FALSE & visa %in% c(NA, 
                                               "Permanent Resident",
                                               "Undocumented Status") ~ "Nonresident",
...
diversity_df <- diversity_all |> 
  mutate(demographic = factor(demographic, levels = c("California Resident",
                                                      "Nonresident",
                                                      "International",
                                                      "Female",
                                                      "Age 25+",
