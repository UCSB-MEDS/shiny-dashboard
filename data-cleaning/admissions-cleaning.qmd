...
# # all years ---- SAME AS tot_enrolled
...
residency <- enrolled |> 
  ...
  mutate(demographic = case_when(
    california_resident == TRUE & visa %in% c(NA, # CA resident
                                              "DACA/AB540",
                                              "Permanent Resident",
                                              "None: DACA Recipient",
                                              "Undocumented Status") ~ "California Resident",
    california_resident == FALSE & visa %in% c(NA, # non-CA resident
                                               "Permanent Resident",
                                               "Undocumented Status") ~ "Nonresident",
    visa %in% c("F-1 Student", # international
                "J-1",
...
write_rds(ug_geoms, "data/ug_geoms.rds")

#...........................ipeds data...........................
write_rds(ipeds, "data/ipeds.rds")

#......................diversity stats data......................
write_rds(diversity_stats, "data/diversity_stats.rds")
