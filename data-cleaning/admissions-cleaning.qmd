...
program_size => tot_enrolled

check on military status
...
#   distinct()
  ...
  # #................fix misspelled university names.................
  # mutate(ug1_name = case_when(
  #   ug1_name %in% c("(Arya Mehr) Sharif U Tech", "Sharif U Tech") ~ "Sharif University of Technology",
  #   ug1_name == "Albert Ludwig University At Freiburg" ~ "Albert Ludwig University of Freiburg",
  #   ug1_name %in% c("Bangladesch University of Engr and Tech", "Bangladesh U - Engineer & Tech", "Bangladesch University of Engr and Tech", "Bangladesh University of Engr and Tech") ~ "Bangladesh University of Engineering and Technology",
  #   ug1_name == "Beijing Inst of Tech" ~ "Beijing Institute of Tecnology",
  #   ug1_name == "Beijing Institute of Tecnology, Zhuhai Campus, Zhu" ~ "Beijing Institute of Tecnology, Zhuhai Campus",
  #   ug1_name == "Beijing U Tech" ~ "Beijing University of Technology",
  #   ug1_name == "Beijing University - Business & Tech" ~ "Beijing Technology and Business University",
  #   ug1_name == "Beijing University - Chemical Tech" ~ "Beijing University of Chemical Technology",
  #   ug1_name == "Biju Patnaik U Tech" ~ "Biju Patnaik University of Technology",
  #   ug1_name %in% c("Birla Inst of Tech & Sci", "Birla Inst of Tech") ~ "Birla Institute of Technology and Science, Pilani",
  #   ug1_name == "Cetys U -Centr Ensenanza Tec Sup" ~ "CETYS Universidad",
  #   ug1_name == "China Medical University (Cmu)" ~ "China Medical University",
  #   ug1_name == "The China University of Geosciences" ~ "The China University of Geosciences",
  #   ug1_name == "China, Peoples Republic U Political", "China University of Political Science and Law",
  #   ug1_name == "Dalian U Tech" ~ "Dalian University of Technology", 
  #   ug1_name == "Delhi College of Engr" ~ "Delhi College of Engineering",
  #   ug1_name == "East China, Peoples Republic Normal" ~ "East China Normal University",
  #   ug1_name == "East China, Peoples Republic U Sci" ~ "East China University of Science and Technology",
  #   ug1_name == "École Polytechnique programs" ~ "École Polytechnique",
  #   ug1_name == "Eindhoven U Techlgy Stu" ~ "Eindhoven University of Technology",
  #   ug1_name == "Goethe University Frankfurt Am Main" ~ "Goethe University Frankfurt",
  #   ug1_name == "Guangdong U Foreign Studies" ~ "Guangdong University of Foreign Studies",
  #   ug1_name == "Hefei U Tech" ~ "Hefei University of Technology",
  #   ug1_name == "Hong Kong Baptist C" ~ "Hong Kong Baptist University",
  #   ug1_name == "Hong Kong U Sci & Tech" ~ "Hong Kong University of Science and Technology",
  #   ug1_name == "Huazhong U Sci & Tech" ~ "Huazhong U Sci & Tech",
  #   ug1_name == "Imperial C of Sci & Tech" ~ "Imperial College of Science, Technology and Medicine",
  #   ug1_name %in% c("Indian Inst of Tech (Iit) - Kharagp", "Indian Inst of Tech (Iit) - Unknown", "Indian Inst Tech (Iit) - Gandhinaga") ~ "Indian Institute of Technology",
    # ug1_name == "Unive Catolica De Goias" ~ "Pontifícia Universidade Católica de Goiás",
    # ug1_name == "Ins Tec Y Estudio De Monterrey" ~ "Instituto Tecnológico y de Estudios Superiores de Monterrey",
    # ug1_name == "Khulna U Engr & Tech" ~ "Khulna University of Engineering & Technology",
    # ug1_name == "Ms Ramaiah Inst of Tech" ~ "Ramaiah Institute of Technology",
    # ug1_name == "Mcgill University" ~ "McGill University",
    # ug1_name == "North South Universi" ~ "North South University",
    # ug1_name == "Hong Ik University" ~ "Hongik University",
    # ug1_name == "Kings College London" ~ "King's College London",
  #   TRUE ~ ug1_name
  # ))
```
...
military <- enrolled |> 
  select(c(admission_year, program, military_service)) |>  
  mutate(military_service = as.numeric(unlist(military_service))) |> 
  filter(military_service > 1) |>
  group_by(program) |>
  summarize(count = n()) |>
...
undocumented <- enrolled |> 
  select(c(admission_year, program, visa)) |> 
  mutate(undocumented_status = case_when(visa %in% c("DACA/AB540",
                                                     "Undocumented Status",
                                                     "None: DACA Recipient") ~ "Yes", 
                                         TRUE ~ "No")) |> 
  group_by(program, undocumented_status) |> 
  summarize(count = n()) |> 
  filter(undocumented_status == "Yes") |> 
...
urm <- enrolled |>  
  ...
  select(admission_year, application_id, program, citizenship_country, residency_country,
         birth_country, visa, background, racial_categories, hispanic_latino) |>  
  ...
  mutate(urm_status = case_when(
    ...
    hispanic_latino == TRUE & citizenship_country == "US" ~ "Y", # earlier years encoded "United States" as "US"
    ...
    str_detect(racial_categories, str_c(category_urms, collapse = "|")) & citizenship_country == "US" ~ "Y",
    str_detect(racial_categories, str_c(category_urms, collapse = "|")) & citizenship_country == "United States" ~ "Y",
    # # permanent residents who identify as urms ----
    str_detect(racial_categories, str_c(category_urms, collapse = "|")) & visa %in% visa_urms ~ "Y",
