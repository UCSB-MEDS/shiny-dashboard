...
write_rds(mesm_status, here::here("bren-student-data-explorer", "data", "mesm_status_cleaned.rds")) # no actual cleaning required; just renamed and saved to bren-student-data-explorer/data/
```
