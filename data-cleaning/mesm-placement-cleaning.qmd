...
mesm_placement <- readRDS(here::here("data", "mesm_placement_2019_2024.rds")) 
```
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##            add missing state abbrv when city is listed (round 2)         ----
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

# some city names have been corrected and we can now add corresponding state names to the `work_location_state` col

  # mutate(work_location_state = case_when(
  #   work_location_city == "Lansing" ~ "MI",
  #   work_location_city == "New York" ~ "NY",
  #   TRUE ~ work_location_state
  # )) |> 
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  #mutate(work_location_state = na_if(work_location_city, "N/A")) |> 
...
```{r}
write_rds(mesm_placement_cleaned, here::here("data", "mesm_placement_cleaned.rds")) 
```
