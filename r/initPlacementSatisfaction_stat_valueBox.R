...
initPlacementSatisfaction_stat_valueBox <- function(input, data) {
  ...
  renderValueBox({
    ...
    valueBox(paste0("of survey respondents from the graduating class of ", curr_year, " ranked being “satisfied” or “very satisfied” with their initial job placement"),
